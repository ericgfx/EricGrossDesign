...
window['ly_cid'] = "0cc652a55557cf28127f70bf821aeaaf";
...
(function(d, w) {
  ...
  w.lio = {
    account: {
      id: "0cc652a55557cf28127f70bf821aeaaf"
    },
    loaded: false,
    ...
    fields: !!w.liosetup && w.liosetup.fields || "ip" || "",
    ...
    getEntity: function(payload){
      ...
      if(apiurl.length > 2000){
        requirepost = true;
        apiurl = w.lio.buildEntityURL('POST');
      }
    ...
    buildEntityURL: function(method, payload){
      ...
      // if we are using the GET method we need the jsonp callback
      if(method === 'GET'){
...
if(typeof window.jstag !== 'object'){
    ...
    initObj.cid = "0cc652a55557cf28127f70bf821aeaaf";
